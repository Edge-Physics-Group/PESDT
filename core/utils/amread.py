...
def A_coeff(transition):
    ...
    coeff_dict = {
        2: {3: 4.699e8, 9: 5.575e7, 4: 1.278e7, 5: 4.125e6, 6: 1.644e6}, 
        9: {3: 4.410e7, 4: 8.419e6, 5: 2.530e6, 6: 9.732e5, 7: 4.389e5},
...
def calc_photon_rate(transition, Temperature, el_density, n_density, mol_n_density = None, molp_n_density = None, p_density = None, h3 = True, recalc_h2_pos = True, **kwargs):
    ...
    if mol_n_density is not None:	
        ...
        if recalc_h2_pos or molp_n_density is None:
            h2_pos_den = calc_cross_sections(MARc_h2_pos_den, T = Temperature, n = el_density)*mol_n_density
        else:
            h2_pos_den = np.array(molp_n_density)
            h2_pos_den = h2_pos_den*1e-6 # Convert to cm^-3
