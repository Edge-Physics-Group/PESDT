...
class spectroscopic_lines_db:
    ...
    def __init__(self):
        ...
        self.data = {"H": self.H_lines, "He": self.He_lines, "C": self.C_lines, "Be": self.Be_lines, "N": self.N_lines, "W": self.W_lines}
        # flatten data
        for species, data in self.data.items():
            ...
            for key, item in data.items():
                ...
                for k, i in item.items():
                    flat_data[k] = (int(i[0]), int(i[1])) # Add items, all transitions are unique
